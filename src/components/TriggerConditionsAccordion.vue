  ...
  <div id="accordion">
    <div class="card">
      <div class="card-header" id="headingOne">
        <h5 class="mb-0">
          <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="color: #4AE387">
            On Data Stream value
          </button>
            <span class="badge badge-primary badge-pill" style="float: right; background-color: #4AE387">{{onDataStreamConditions.length}}</span>
        </h5>
      </div>
    ...
    <div class="card">
      <div class="card-header" id="headingTwo">
        <h5 class="mb-0">
          <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="color: #4AE387">
            When Data Stream has not been updated
          </button>
          <span class="badge badge-primary badge-pill" style="float: right; background-color: #4AE387">{{dataStreamNotUpdatedConditions.length}}</span>
        </h5>
      </div>
    ...
    <div class="card">
      <div class="card-header" id="headingThree">
        <h5 class="mb-0">
          <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="color: #4AE387">
            Time interval
          </button>
          <span class="badge badge-primary badge-pill" style="float: right; background-color: #4AE387">{{timeIntervalConditions.length}}</span>
        </h5>
      </div>
